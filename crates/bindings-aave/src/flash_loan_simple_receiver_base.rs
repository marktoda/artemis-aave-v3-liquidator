...
pub mod flash_loan_simple_receiver_base {
    ...
    pub static FLASHLOANSIMPLERECEIVERBASE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct FlashLoanSimpleReceiverBase<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for FlashLoanSimpleReceiverBase<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for FlashLoanSimpleReceiverBase<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for FlashLoanSimpleReceiverBase<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for FlashLoanSimpleReceiverBase<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(FlashLoanSimpleReceiverBase))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl ::core::fmt::Display for FlashLoanSimpleReceiverBaseCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for FlashLoanSimpleReceiverBaseCalls {
        fn from(value: AddressesProviderCall) -> Self {
            Self::AddressesProvider(value)
        }
    }
    impl ::core::convert::From<PoolCall> for FlashLoanSimpleReceiverBaseCalls {
