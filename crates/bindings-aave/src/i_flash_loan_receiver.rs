...
pub mod i_flash_loan_receiver {
    ...
    pub enum IFlashLoanReceiverCalls {
        AddressesProvider(AddressesProviderCall),
        Pool(PoolCall),
        ExecuteOperation(ExecuteOperationCall),
    }
    impl ::ethers::core::abi::AbiDecode for IFlashLoanReceiverCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IFlashLoanReceiverCalls {
    ...
    impl ::core::fmt::Display for IFlashLoanReceiverCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddressesProviderCall> for IFlashLoanReceiverCalls {
        fn from(value: AddressesProviderCall) -> Self {
            Self::AddressesProvider(value)
        }
    }
    impl ::core::convert::From<PoolCall> for IFlashLoanReceiverCalls {
        fn from(value: PoolCall) -> Self {
            Self::Pool(value)
        }
    }
    impl ::core::convert::From<ExecuteOperationCall> for IFlashLoanReceiverCalls {
