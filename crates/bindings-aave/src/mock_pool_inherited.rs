...
pub mod mock_pool_inherited {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("setMaxNumberOfReserves"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned(
    ...
    pub static MOCKPOOLINHERITED_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct MockPoolInherited<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for MockPoolInherited<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for MockPoolInherited<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for MockPoolInherited<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for MockPoolInherited<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(MockPoolInherited))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> MockPoolInherited<M> {
        ...
        ///Calls the contract's `setMaxNumberOfReserves` (0x57c68dc4) function
        pub fn set_max_number_of_reserves(
            &self,
            new_max_number_of_reserves: u16,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([87, 198, 141, 196], new_max_number_of_reserves)
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            MockPoolInheritedEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for MockPoolInherited<M> {
    ...
    pub enum MockPoolInheritedEvents {
    ...
    impl ::ethers::contract::EthLogDecode for MockPoolInheritedEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = BackUnbackedFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::BackUnbackedFilter(decoded));
            }
            if let Ok(decoded) = BorrowFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::BorrowFilter(decoded));
            }
            if let Ok(decoded) = FlashLoanFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::FlashLoanFilter(decoded));
            }
            if let Ok(decoded) = IsolationModeTotalDebtUpdatedFilter::decode_log(log) {
                return Ok(
                    MockPoolInheritedEvents::IsolationModeTotalDebtUpdatedFilter(decoded),
                );
            }
            if let Ok(decoded) = LiquidationCallFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::LiquidationCallFilter(decoded));
            }
            if let Ok(decoded) = MintUnbackedFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::MintUnbackedFilter(decoded));
            }
            if let Ok(decoded) = MintedToTreasuryFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::MintedToTreasuryFilter(decoded));
            }
            if let Ok(decoded) = RebalanceStableBorrowRateFilter::decode_log(log) {
                return Ok(
                    MockPoolInheritedEvents::RebalanceStableBorrowRateFilter(decoded),
                );
            }
            if let Ok(decoded) = RepayFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::RepayFilter(decoded));
            }
            if let Ok(decoded) = ReserveDataUpdatedFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::ReserveDataUpdatedFilter(decoded));
            }
            if let Ok(decoded) = ReserveUsedAsCollateralDisabledFilter::decode_log(log) {
                return Ok(
                    MockPoolInheritedEvents::ReserveUsedAsCollateralDisabledFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = ReserveUsedAsCollateralEnabledFilter::decode_log(log) {
                return Ok(
                    MockPoolInheritedEvents::ReserveUsedAsCollateralEnabledFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = SupplyFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::SupplyFilter(decoded));
            }
            if let Ok(decoded) = SwapBorrowRateModeFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::SwapBorrowRateModeFilter(decoded));
            }
            if let Ok(decoded) = UserEModeSetFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::UserEModeSetFilter(decoded));
            }
            if let Ok(decoded) = WithdrawFilter::decode_log(log) {
                return Ok(MockPoolInheritedEvents::WithdrawFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for MockPoolInheritedEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<BackUnbackedFilter> for MockPoolInheritedEvents {
        fn from(value: BackUnbackedFilter) -> Self {
            Self::BackUnbackedFilter(value)
        }
    }
    impl ::core::convert::From<BorrowFilter> for MockPoolInheritedEvents {
        fn from(value: BorrowFilter) -> Self {
            Self::BorrowFilter(value)
        }
    }
    impl ::core::convert::From<FlashLoanFilter> for MockPoolInheritedEvents {
        fn from(value: FlashLoanFilter) -> Self {
            Self::FlashLoanFilter(value)
        }
    }
    impl ::core::convert::From<IsolationModeTotalDebtUpdatedFilter>
    for MockPoolInheritedEvents {
        fn from(value: IsolationModeTotalDebtUpdatedFilter) -> Self {
            Self::IsolationModeTotalDebtUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<LiquidationCallFilter> for MockPoolInheritedEvents {
        fn from(value: LiquidationCallFilter) -> Self {
            Self::LiquidationCallFilter(value)
        }
    }
    impl ::core::convert::From<MintUnbackedFilter> for MockPoolInheritedEvents {
        fn from(value: MintUnbackedFilter) -> Self {
            Self::MintUnbackedFilter(value)
        }
    }
    impl ::core::convert::From<MintedToTreasuryFilter> for MockPoolInheritedEvents {
        fn from(value: MintedToTreasuryFilter) -> Self {
            Self::MintedToTreasuryFilter(value)
        }
    }
    impl ::core::convert::From<RebalanceStableBorrowRateFilter>
    for MockPoolInheritedEvents {
        fn from(value: RebalanceStableBorrowRateFilter) -> Self {
            Self::RebalanceStableBorrowRateFilter(value)
        }
    }
    impl ::core::convert::From<RepayFilter> for MockPoolInheritedEvents {
        fn from(value: RepayFilter) -> Self {
            Self::RepayFilter(value)
        }
    }
    impl ::core::convert::From<ReserveDataUpdatedFilter> for MockPoolInheritedEvents {
    ...
    impl ::core::convert::From<SupplyFilter> for MockPoolInheritedEvents {
        fn from(value: SupplyFilter) -> Self {
            Self::SupplyFilter(value)
        }
    }
    impl ::core::convert::From<SwapBorrowRateModeFilter> for MockPoolInheritedEvents {
        fn from(value: SwapBorrowRateModeFilter) -> Self {
            Self::SwapBorrowRateModeFilter(value)
        }
    }
    impl ::core::convert::From<UserEModeSetFilter> for MockPoolInheritedEvents {
        fn from(value: UserEModeSetFilter) -> Self {
            Self::UserEModeSetFilter(value)
        }
    }
    impl ::core::convert::From<WithdrawFilter> for MockPoolInheritedEvents {
    ...
    ///Container type for all input parameters for the `setMaxNumberOfReserves` function with signature `setMaxNumberOfReserves(uint16)` and selector `0x57c68dc4`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "setMaxNumberOfReserves", abi = "setMaxNumberOfReserves(uint16)")]
    pub struct SetMaxNumberOfReservesCall {
        pub new_max_number_of_reserves: u16,
    }
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum MockPoolInheritedCalls {
        ...
        SetMaxNumberOfReserves(SetMaxNumberOfReservesCall),
    ...
    impl ::ethers::core::abi::AbiDecode for MockPoolInheritedCalls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded)
                = <SetMaxNumberOfReservesCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::SetMaxNumberOfReserves(decoded));
            }
            if let Ok(decoded)
    ...
    impl ::ethers::core::abi::AbiEncode for MockPoolInheritedCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::SetMaxNumberOfReserves(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::fmt::Display for MockPoolInheritedCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddressesProviderCall> for MockPoolInheritedCalls {
        fn from(value: AddressesProviderCall) -> Self {
            Self::AddressesProvider(value)
        }
    }
    impl ::core::convert::From<BridgeProtocolFeeCall> for MockPoolInheritedCalls {
        fn from(value: BridgeProtocolFeeCall) -> Self {
            Self::BridgeProtocolFee(value)
        }
    }
    impl ::core::convert::From<FlashloanPremiumTotalCall> for MockPoolInheritedCalls {
        fn from(value: FlashloanPremiumTotalCall) -> Self {
            Self::FlashloanPremiumTotal(value)
        }
    }
    impl ::core::convert::From<FlashloanPremiumToProtocolCall>
    for MockPoolInheritedCalls {
        fn from(value: FlashloanPremiumToProtocolCall) -> Self {
            Self::FlashloanPremiumToProtocol(value)
        }
    }
    impl ::core::convert::From<MaxNumberReservesCall> for MockPoolInheritedCalls {
        fn from(value: MaxNumberReservesCall) -> Self {
            Self::MaxNumberReserves(value)
        }
    }
    impl ::core::convert::From<MaxStableRateBorrowSizePercentCall>
    for MockPoolInheritedCalls {
        fn from(value: MaxStableRateBorrowSizePercentCall) -> Self {
            Self::MaxStableRateBorrowSizePercent(value)
        }
    }
    impl ::core::convert::From<PoolRevisionCall> for MockPoolInheritedCalls {
        fn from(value: PoolRevisionCall) -> Self {
            Self::PoolRevision(value)
        }
    }
    impl ::core::convert::From<BackUnbackedCall> for MockPoolInheritedCalls {
        fn from(value: BackUnbackedCall) -> Self {
            Self::BackUnbacked(value)
        }
    }
    impl ::core::convert::From<BorrowCall> for MockPoolInheritedCalls {
        fn from(value: BorrowCall) -> Self {
            Self::Borrow(value)
        }
    }
    impl ::core::convert::From<ConfigureEModeCategoryCall> for MockPoolInheritedCalls {
        fn from(value: ConfigureEModeCategoryCall) -> Self {
            Self::ConfigureEModeCategory(value)
        }
    }
    impl ::core::convert::From<DepositCall> for MockPoolInheritedCalls {
        fn from(value: DepositCall) -> Self {
            Self::Deposit(value)
        }
    }
    impl ::core::convert::From<DropReserveCall> for MockPoolInheritedCalls {
        fn from(value: DropReserveCall) -> Self {
            Self::DropReserve(value)
        }
    }
    impl ::core::convert::From<FinalizeTransferCall> for MockPoolInheritedCalls {
        fn from(value: FinalizeTransferCall) -> Self {
            Self::FinalizeTransfer(value)
        }
    }
    impl ::core::convert::From<FlashLoanCall> for MockPoolInheritedCalls {
        fn from(value: FlashLoanCall) -> Self {
            Self::FlashLoan(value)
        }
    }
    impl ::core::convert::From<FlashLoanSimpleCall> for MockPoolInheritedCalls {
        fn from(value: FlashLoanSimpleCall) -> Self {
            Self::FlashLoanSimple(value)
        }
    }
    impl ::core::convert::From<GetConfigurationCall> for MockPoolInheritedCalls {
        fn from(value: GetConfigurationCall) -> Self {
            Self::GetConfiguration(value)
        }
    }
    impl ::core::convert::From<GetEModeCategoryDataCall> for MockPoolInheritedCalls {
        fn from(value: GetEModeCategoryDataCall) -> Self {
            Self::GetEModeCategoryData(value)
        }
    }
    impl ::core::convert::From<GetReserveAddressByIdCall> for MockPoolInheritedCalls {
        fn from(value: GetReserveAddressByIdCall) -> Self {
            Self::GetReserveAddressById(value)
        }
    }
    impl ::core::convert::From<GetReserveDataCall> for MockPoolInheritedCalls {
    ...
    impl ::core::convert::From<GetReservesListCall> for MockPoolInheritedCalls {
        fn from(value: GetReservesListCall) -> Self {
            Self::GetReservesList(value)
        }
    }
    impl ::core::convert::From<GetUserAccountDataCall> for MockPoolInheritedCalls {
        fn from(value: GetUserAccountDataCall) -> Self {
            Self::GetUserAccountData(value)
        }
    }
    impl ::core::convert::From<GetUserConfigurationCall> for MockPoolInheritedCalls {
        fn from(value: GetUserConfigurationCall) -> Self {
            Self::GetUserConfiguration(value)
        }
    }
    impl ::core::convert::From<GetUserEModeCall> for MockPoolInheritedCalls {
        fn from(value: GetUserEModeCall) -> Self {
            Self::GetUserEMode(value)
        }
    }
    impl ::core::convert::From<InitReserveCall> for MockPoolInheritedCalls {
        fn from(value: InitReserveCall) -> Self {
            Self::InitReserve(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for MockPoolInheritedCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<LiquidationCallCall> for MockPoolInheritedCalls {
        fn from(value: LiquidationCallCall) -> Self {
            Self::LiquidationCall(value)
        }
    }
    impl ::core::convert::From<MintToTreasuryCall> for MockPoolInheritedCalls {
        fn from(value: MintToTreasuryCall) -> Self {
            Self::MintToTreasury(value)
        }
    }
    impl ::core::convert::From<MintUnbackedCall> for MockPoolInheritedCalls {
    ...
    impl ::core::convert::From<RepayCall> for MockPoolInheritedCalls {
        fn from(value: RepayCall) -> Self {
            Self::Repay(value)
        }
    }
    impl ::core::convert::From<RepayWithATokensCall> for MockPoolInheritedCalls {
        fn from(value: RepayWithATokensCall) -> Self {
            Self::RepayWithATokens(value)
        }
    }
    impl ::core::convert::From<RepayWithPermitCall> for MockPoolInheritedCalls {
        fn from(value: RepayWithPermitCall) -> Self {
            Self::RepayWithPermit(value)
        }
    }
    impl ::core::convert::From<RescueTokensCall> for MockPoolInheritedCalls {
    ...
    impl ::core::convert::From<SetConfigurationCall> for MockPoolInheritedCalls {
        fn from(value: SetConfigurationCall) -> Self {
            Self::SetConfiguration(value)
        }
    }
    impl ::core::convert::From<SetMaxNumberOfReservesCall> for MockPoolInheritedCalls {
        fn from(value: SetMaxNumberOfReservesCall) -> Self {
            Self::SetMaxNumberOfReserves(value)
        }
    }
    ...
    impl ::core::convert::From<SetUserEModeCall> for MockPoolInheritedCalls {
    ...
    impl ::core::convert::From<SupplyCall> for MockPoolInheritedCalls {
        fn from(value: SupplyCall) -> Self {
            Self::Supply(value)
        }
    }
    impl ::core::convert::From<SupplyWithPermitCall> for MockPoolInheritedCalls {
        fn from(value: SupplyWithPermitCall) -> Self {
            Self::SupplyWithPermit(value)
        }
    }
    impl ::core::convert::From<SwapBorrowRateModeCall> for MockPoolInheritedCalls {
        fn from(value: SwapBorrowRateModeCall) -> Self {
            Self::SwapBorrowRateMode(value)
        }
    }
    impl ::core::convert::From<UpdateBridgeProtocolFeeCall> for MockPoolInheritedCalls {
        fn from(value: UpdateBridgeProtocolFeeCall) -> Self {
            Self::UpdateBridgeProtocolFee(value)
        }
    }
    impl ::core::convert::From<UpdateFlashloanPremiumsCall> for MockPoolInheritedCalls {
        fn from(value: UpdateFlashloanPremiumsCall) -> Self {
            Self::UpdateFlashloanPremiums(value)
        }
    }
    impl ::core::convert::From<WithdrawCall> for MockPoolInheritedCalls {
